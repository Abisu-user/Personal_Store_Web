...
const changes = ["src/app/(app)/vault/page.tsx", "src/app/(app)/security/page.tsx", "src/components/vault/vault-workspace.tsx", "src/components/ui/mobile-batch-action-bar.tsx"];
