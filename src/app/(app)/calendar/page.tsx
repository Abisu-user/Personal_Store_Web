...
export default async function CalendarPage() {
  ...
  return <main className={`dashboard ${mobileStyles.calendarPage}`}><section className="dashboard-card"><p className="eyebrow">CALENDAR</p><h1>私人日曆</h1><p>整理提醒、重要日期與待辦事項。請勿在行程中放入密碼、金鑰或 Recovery Code。</p><CalendarWorkspace initialData={initialData} /></section></main>;
}
