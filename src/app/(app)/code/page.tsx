...
export default async function CodePage() {
  ...
  return <main className="dashboard"><section className="dashboard-card"><div className="page-heading"><div><p className="eyebrow">CODE SNIPPETS</p><h1>程式碼片段</h1><p>安全保存常用指令、範例與設定檔，依程式語言、分類與標籤快速找回。</p></div><CreateItemButton kind="code">＋ 新增程式碼</CreateItemButton></div><CodeWorkspace initialData={initialData} /></section></main>;
}
