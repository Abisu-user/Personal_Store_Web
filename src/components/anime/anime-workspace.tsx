...
function AnimeFolderNavigation({ folders, onChange, onFoldersChange, scope, selectedId }: { folders: AnimeWorkspaceData["folders"]; onChange: (folderId: string | null) => void; onFoldersChange: (folders: AnimeWorkspaceData["folders"]) => void; scope: CategoryScope; selectedId: string | null }) {
...
export function AnimeWorkspace({ initialData }: { initialData?: AnimeWorkspaceData }) {
  ...
  return <section className="anime-workspace">
    ...
    {tab === "adult" && adultUnlocked && adultData && <section className="anime-adult-workspace">
      ...
      {adultView === "library" ? <>
        <AnimeFolderNavigation folders={adultData.folders} onChange={(folderId) => { setAdultLibraryView("library"); setAdultFolderFilter(folderId); setAdultCategoryFilter(null); }} onFoldersChange={(folders) => setAdultData((current) => current ? { ...current, folders } : current)} scope="adult" selectedId={adultFolderFilter} />
    ...
    {tab === "library" && <>
      ...
      <AnimeFolderNavigation folders={data.folders} onChange={(folderId) => { setLibraryView("library"); setFolderFilter(folderId); setCategoryFilter(null); }} onFoldersChange={(folders) => setData((current) => ({ ...current, folders }))} scope="standard" selectedId={folderFilter} />
