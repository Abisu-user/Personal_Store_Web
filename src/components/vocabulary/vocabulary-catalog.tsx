...
type CatalogExample = { id: string; senseId: string | null; sentence: string; reading: string | null; translationZhTw: string | null; difficultyLevel: string; source: string; isVerified: boolean; kind: "system" | "user" | "ai" };
