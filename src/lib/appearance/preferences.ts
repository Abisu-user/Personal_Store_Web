...
export function applyAppearance(appearance: Appearance) {
  ...
  root.style.setProperty("--mobile-nav-user-color", normalized.mobileNavigation.backgroundColor); root.style.setProperty("--mobile-nav-user-opacity", `${normalized.mobileNavigation.opacity}%`);
