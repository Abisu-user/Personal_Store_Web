...
const limits: Record<B2UploadPurpose, number> = {
  ...
  "workspace-background-desktop": 8_388_608,
  "workspace-background-mobile": 8_388_608,
...
export function b2MetadataCategory(purpose: B2UploadPurpose) {
  return purpose.startsWith("workspace-background") ? "workspace-backgrounds" : purpose;
}
