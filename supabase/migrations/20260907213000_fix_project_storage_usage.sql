-- Fix the project Storage total: the outer aggregate receives used_bytes,
-- not the byte_size column from the inner object scan.
...
begin
  ...
  begin
    ...
    select
      ...
      coalesce(jsonb_agg(
        jsonb_build_object('category', category, 'usedBytes', used_bytes)
